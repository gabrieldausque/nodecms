						...
						foreach($this->items as $i => $item) {
							...
							<tr class="row<?php echo $i % 2; ?>">
								...
								<td class="has-context">
									...
									<a class="hasToolTip" href="<?php echo Route::_('index.php?option=com_teama&task=' . $this->item_single_name . '.edit&id=' . (int)$item->id); ?>"
								...
								<?php foreach ($this->field_to_display as $field) { ?>
								<td class="d-none d-md-table-cell">
									<?php
										echo $item->get($field->name);
									?>
								</td>
								<?php } ?>
							</tr>
