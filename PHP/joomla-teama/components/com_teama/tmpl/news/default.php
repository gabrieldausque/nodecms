...
<div class="teama-section">
    ...
    <div class="teama-section-news">
        ...
        <div id="next-news" class="card teama-news-card link-to-all-news"
		     ...
		     $paginationPages = $this->pagination->getPaginationPages();
		     $startIndex = 0;
		     if(array_key_exists('next', $paginationPages)){
			     $nextPage = $this->pagination->getPaginationPages()['next'];
			     if(isset($nextPage))
				     $startIndex = $this->pagination->getPaginationPages()['next']['data']->base;
		     }
